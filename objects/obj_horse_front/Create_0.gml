...
for (i = 0; i < 2; i++){
	...
	legB = instance_create_depth((x-3)+(16*i), y+24, 9998, obj_horse_leg);
	hoof = instance_create_depth((x-3)+(16*i), y+38, 9999, obj_horse_hoof);
	physics_joint_revolute_create(id, legA, (x-3)+(16*i), y+10, -30, 30, true, 0, 0, 0, 0);
...
physics_joint_revolute_create(id, head, x+15, y-15, -15, 15, true, 0, 0, 0, 0);